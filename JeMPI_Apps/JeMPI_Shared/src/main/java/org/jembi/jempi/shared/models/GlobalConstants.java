...
public final class GlobalConstants {
   ...
   public static final String TOPIC_INTERACTION_CONTROLLER = "JeMPI-patient-controller";
   public static final String TOPIC_INTERACTION_EM = "JeMPI-patient-em";
   public static final String TOPIC_INTERACTION_LINKER = "JeMPI-patient-linker";
