...
import org.jembi.jempi.linker.thresholdRangeProcessor.standardRangeProcessor.processors.FieldPairEqualityProcessor.FieldPairEqualityProcessor;
...
public class StandardThresholdRangeProcessor extends BaseThresholdProcessor {
    ...
    protected List<IThresholdRangeSubProcessor> getSubProcessors() {
        return List.of(new FieldPairEqualityProcessor(this.linkerId, this.originalInteraction));
    }
