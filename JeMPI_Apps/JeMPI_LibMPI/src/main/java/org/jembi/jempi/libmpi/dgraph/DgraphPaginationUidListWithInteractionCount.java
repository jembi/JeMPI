...
public record DgraphPaginationUidListWithInteractionCount(
      @JsonProperty("all") List<DgraphUid> all,
   ...
   DgraphPaginationUidListWithInteractionCount(
         @JsonProperty("all") final List<DgraphUid> all,
         @JsonProperty("interactionCount") final List<LibMPIInteractionCount> interactionCount) {
