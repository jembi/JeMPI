...
final class Mutations {
   ...
   static LibMPIClientInterface.LinkInfo addNewDGraphEntity(final CustomEntity customEntity) {
      ...
      return new LibMPIClientInterface.LinkInfo(grUID, result.entityUid, 1.0F);
   }
   ...
   static Either<MpiGeneralError, LibMPIClientInterface.LinkInfo> unLink(final String goldenID,
      ...
      return Either.right(new LibMPIClientInterface.LinkInfo(newGoldenID, entityID, score));
   }

   static Either<MpiGeneralError, LibMPIClientInterface.LinkInfo> updateLink(final String goldenID, final String newGoldenID,
   ...
   static LibMPIClientInterface.LinkInfo linkDGraphEntity(final CustomEntity customEntity,
      ...
      return new LibMPIClientInterface.LinkInfo(grUID, result.entityUid, theScore);
   }
