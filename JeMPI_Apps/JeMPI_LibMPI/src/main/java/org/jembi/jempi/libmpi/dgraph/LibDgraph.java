...
//      final var dgraphEntity = new CustomLibMPIDGraphEntity(mpiEntity.entity(), mpiEntity.score());
   ...
   public Either<MpiGeneralError, LinkInfo> updateLink(final String goldenID, final String newGoldenID, final String entityID,
                                                       final float score) {
...
//      final var dgraphEntity = new CustomLibMPIDGraphEntity(customEntity, goldenIdScore);
