...
public final class AppConfig {
    ...
    public static final String KAFKA_APPLICATION_ID_JOURNAL = CONFIG.getString("kafka.application-id-journal");
    public static final String KAFKA_CLIENT_ID_JOURNAL = CONFIG.getString("kafka.client-id-journal");
