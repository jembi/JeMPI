...
public final class AppConfig {
   ...
   public static final String API_SERVER_HOST = CONFIG.getString("api-server.host");
   public static final Integer API_SERVER_PORT = CONFIG.getInt("api-server.port");
   public static final String LINKER_SERVER_HOST = CONFIG.getString("linker-server.host");
   public static final Integer LINKER_SERVER_PORT = CONFIG.getInt("linker-server.port");
