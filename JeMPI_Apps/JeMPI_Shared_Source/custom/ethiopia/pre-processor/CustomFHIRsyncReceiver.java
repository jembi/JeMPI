   ...
   private Route routeLinkEntity() {
      return entity(Unmarshaller.entityToString(),
                    json -> {
                       ...
                       final String nameFather = patient.getExtensionByUrl("http://jempi.org/fhir/StructureDefinition/name-father").getValue().toString();
                       final String nameFathersFather = patient.getExtensionByUrl("http://jempi.org/fhir/StructureDefinition/name-fathers-father").getValue().toString();
                       final String nameMother = patient.getExtensionByUrl("http://jempi.org/fhir/StructureDefinition/name-mother").getValue().toString();
                       final String nameMothersFather = patient.getExtensionByUrl("http://jempi.org/fhir/StructureDefinition/name-mothers-father").getValue().toString();
                       ...
                       final String nameGiven = name != null && name.hasGiven() ? name.getGiven().get(0).getValue() : null;
