...
class CustomSender {
   ...
   private void dispatchPatient(final String stan, final String[] fields) {
      ...
      final var nameGiven = rec.nameGiven();
      final var nameFather = rec.nameFather();
      final var nameFathersFather = rec.nameFathersFather();
      final var nameMother = rec.nameMother();
      final var nameMothersFather = rec.nameMothersFather();
