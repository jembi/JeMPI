...
ThisBuild / libraryDependencies += "com.fasterxml.jackson.core" % "jackson-databind" % "2.16.0"

// https://mvnrepository.com/artifact/com.fasterxml.jackson.module/jackson-module-scala
ThisBuild / libraryDependencies += "com.fasterxml.jackson.module" %% "jackson-module-scala" % "2.16.0"
