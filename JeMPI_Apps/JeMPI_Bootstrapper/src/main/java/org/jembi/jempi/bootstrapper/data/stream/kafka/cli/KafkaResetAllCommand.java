...
@CommandLine.Command(name = "resetAll", mixinStandardHelpOptions = true, description = "Deletes all data and schemas associated with JeMPI kafka instance, then recreated schemas, and add initial data.")
