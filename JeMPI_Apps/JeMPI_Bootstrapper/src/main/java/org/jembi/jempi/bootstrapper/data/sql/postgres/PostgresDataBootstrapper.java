...
public class PostgresDataBootstrapper extends DataBootstrapper {
   ...
   protected List<DBSchemaDetails> getAllDbSchemas() {
      return List.of(
            new DBSchemaDetails(this.loadedConfig.POSTGRESQL_USERS_DB,
                  DataBootstraperConsts.POSTGRES_INIT_SCHEMA_USERS_DB),
            ...
            new DBSchemaDetails(this.loadedConfig.POSTGRESQL_AUDIT_DB,
                  DataBootstraperConsts.POSTGRES_INIT_SCHEMA_AUDIT_DB),
