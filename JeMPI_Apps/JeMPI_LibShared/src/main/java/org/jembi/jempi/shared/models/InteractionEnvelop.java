...
public record InteractionEnvelop(
   ...
   public enum ContentType {
      BATCH_START_SENTINEL(ContentType.MESSAGE_START_VALUE), BATCH_END_SENTINEL(ContentType.MESSAGE_END_VALUE), BATCH_INTERACTION(
            ContentType.MESSAGE_INTERACTION_VALUE);
