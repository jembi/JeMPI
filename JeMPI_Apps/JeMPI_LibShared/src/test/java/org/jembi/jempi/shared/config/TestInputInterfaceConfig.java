...
class TestInputInterfaceConfig {
   ...
   void testDemographicData() {
      Assertions.assertEquals(7, INPUT_INTERFACE_CONFIG_1.demographicDataCsvCols.size());
      Assertions.assertEquals(7, INPUT_INTERFACE_CONFIG_2.demographicDataCsvCols.size());
   ...
   void testAuxInteractionData() {
      Assertions.assertEquals(3, INPUT_INTERFACE_CONFIG_1.auxInteractionDataCsvCols.size());
      Assertions.assertEquals(3, INPUT_INTERFACE_CONFIG_2.auxInteractionDataCsvCols.size());
      Assertions.assertEquals(1, INPUT_INTERFACE_CONFIG_1.additionalNodesCsvCols.size());
      Assertions.assertEquals(1, INPUT_INTERFACE_CONFIG_2.additionalNodesCsvCols.size());
...
//                              INPUT_INTERFACE_CONFIG_2.auxInteractionDataCsvCols);
   ...
   void testAdditionalNodes() {
      ...
      Assertions.assertEquals(
            ...
            INPUT_INTERFACE_CONFIG_1.additionalNodesCsvCols);
      Assertions.assertEquals(
            new HashMap<>(
                  Map.ofEntries(
                        new AbstractMap.SimpleEntry<String, Map<String, Integer>>(
                              ...
                              new AbstractMap.SimpleEntry<>("facility", 8),
                              new AbstractMap.SimpleEntry<>("patient", 9)))))),
            INPUT_INTERFACE_CONFIG_2.additionalNodesCsvCols);
