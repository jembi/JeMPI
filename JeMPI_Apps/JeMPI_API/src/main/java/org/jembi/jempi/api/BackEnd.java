...
public class BackEnd extends AbstractBehavior<BackEnd.Event> {
   ...
   public record EventPatchLinkRsp(Either<MpiGeneralError, LibMPIClientInterface.LinkInfo> linkInfo) implements EventResponse {}
   ...
   public record EventPatchUnLinkRsp(Either<MpiGeneralError, LibMPIClientInterface.LinkInfo> linkInfo) implements EventResponse {}
