...
public class UserSession extends User {
    ...
    * The third argument is a serializer responsible for preparing the data to be sent/received over the wire. There are some
    * ready-to-use serializers available
