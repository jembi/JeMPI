...
TOPIC_INTERACTION_VALIDATE="JeMPI-interaction-validate"
TOPIC_INTERACTION_MATCH="JeMPI-interaction-match"
...
declare -a TOPICS=(
  ...
  $TOPIC_INTERACTION_VALIDATE
  $TOPIC_INTERACTION_MATCH
  $TOPIC_MU_CONTROLLER
  $TOPIC_MU_LINKER
  $TOPIC_AUDIT_TRAIL
  $TOPIC_NOTIFICATIONS
...
PARTITIONS[$TOPIC_INTERACTION_LINKER]=${SCALE_LINKER:-1}
PARTITIONS[$TOPIC_INTERACTION_VALIDATE]=1
PARTITIONS[$TOPIC_INTERACTION_MATCH]=1
...
REPLICATION[$TOPIC_INTERACTION_VALIDATE]=1
REPLICATION[$TOPIC_INTERACTION_MATCH]=1
...
RETENTION_MS[$TOPIC_INTERACTION_VALIDATE]=`echo "1*24*60*60*1000" | bc`
RETENTION_MS[$TOPIC_INTERACTION_MATCH]=`echo "1*24*60*60*1000" | bc`
...
SEGMENT_BYTES[$TOPIC_INTERACTION_VALIDATE]=`echo "4*1024*1024" | bc`
SEGMENT_BYTES[$TOPIC_INTERACTION_MATCH]=`echo "4*1024*1024" | bc`
