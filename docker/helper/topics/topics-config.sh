...
TOPIC_MANUAL_LINK="JeMPI-manual-link"
...
PARTITIONS[$TOPIC_MANUAL_LINK]=1
...
REPLICATION[$TOPIC_MANUAL_LINK]=2
...
RETENTION_MS[$TOPIC_MANUAL_LINK]=`echo "1*24*60*60*1000" | bc`
...
SEGMENT_BYTES[$TOPIC_MANUAL_LINK]=`echo "4*1024*1024" | bc`
