...
TOPIC_PATIENT_STAGING_02="JeMPI-patient-staging-02"
TOPIC_PATIENT_STAGING_DISI="JeMPI-patient-staging-disi"
...
declare -a TOPICS=(
  ...
  $TOPIC_PATIENT_STAGING_02
  $TOPIC_PATIENT_STAGING_DISI
...
PARTITIONS[$TOPIC_PATIENT_STAGING_02]=1
PARTITIONS[$TOPIC_PATIENT_STAGING_DISI]=1
...
REPLICATION[$TOPIC_PATIENT_STAGING_02]=2
REPLICATION[$TOPIC_PATIENT_STAGING_DISI]=2
...
RETENTION_MS[$TOPIC_PATIENT_STAGING_02]=`echo "1*24*60*60*1000" | bc`
RETENTION_MS[$TOPIC_PATIENT_STAGING_DISI]=`echo "1*24*60*60*1000" | bc`
...
SEGMENT_BYTES[$TOPIC_PATIENT_STAGING_02]=`echo "4*1024*1024" | bc`
SEGMENT_BYTES[$TOPIC_PATIENT_STAGING_DISI]=`echo "4*1024*1024" | bc`
