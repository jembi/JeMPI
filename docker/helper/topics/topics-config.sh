...
TOPIC_MANUAL_LINKAGE="JeMPI-manual-linkage"
...
PARTITIONS[$TOPIC_MANUAL_LINKAGE]=1
...
REPLICATION[$TOPIC_MANUAL_LINKAGE]=2
...
RETENTION_MS[$TOPIC_MANUAL_LINKAGE]=`echo "1*24*60*60*1000" | bc`
...
SEGMENT_BYTES[$TOPIC_MANUAL_LINKAGE]=`echo "4*1024*1024" | bc`
