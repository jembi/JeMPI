...
TOPIC_PATIENT_ASYNC_PREPROCESSOR="JeMPI-async-preprocessor"
...
declare -a TOPICS=(
  $TOPIC_PATIENT_ASYNC_PREPROCESSOR
...
PARTITIONS[$TOPIC_PATIENT_ASYNC_PREPROCESSOR]=1
...
REPLICATION[$TOPIC_PATIENT_ASYNC_PREPROCESSOR]=2
...
RETENTION_MS[$TOPIC_PATIENT_ASYNC_PREPROCESSOR]=`echo "1*24*60*60*1000" | bc`
...
SEGMENT_BYTES[$TOPIC_PATIENT_ASYNC_PREPROCESSOR]=`echo "4*1024*1024" | bc`
