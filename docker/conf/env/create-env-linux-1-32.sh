...
export INPUT_02_LIMIT_MEMORY=1G
export STAGING_02_LIMIT_MEMORY=1G

export INPUT_DISI_LIMIT_MEMORY=1G
export STAGING_DISI_LIMIT_MEMORY=1G

export CONTROLLER_LIMIT_MEMORY=2G
export EM_LIMIT_MEMORY=3G
export LINKER_LIMIT_MEMORY=3G
export API_LIMIT_MEMORY=1G
export JOURNAL_LIMIT_MEMORY=2G
export NOTIFICATIONS_LIMIT_MEMORY=2G
