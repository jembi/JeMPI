...
export PROJECT_DIR=/home/nadia/JeMPI/docker
...
export NODE1=nadiasrv
export NODE1_IP=192.168.10.821
...
export MYSQL_EM_LIMIT_MEMORY=1G
...
export TESTER_LIMIT_MEMORY=2G
export STAGING_LIMIT_MEMORY=2G
...
export MYSQL_EM_RESERVATION_MEMORY=512M
...
export TESTER_RESERVATION_MEMORY=512M
export STAGING_RESERVATION_MEMORY=512M
